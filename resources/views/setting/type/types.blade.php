...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ trans('main_trans.Study') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('main_trans.Certificate_types') }}</span>
						</div>
					</div>
                                    ...
                                    <div class="table-responsive hoverable-table">
                                        <table class="table table-hover" id="sortable-table" data-page-length='50' style=" text-align: center;">
                                            ...
                                            <tr>
                                                ...
                                                <th class="wd-5p border-bottom-0">{{ trans('main_trans.Number_of_subjects') }}</th>
                                            ...
                                            <tr data-id="{{ $type->id }}">
                                                ...
                                                <td>{{ $type->id }}</td>
                                                <td>{{ $type->name }}</td>
                                                <td>{{ \App\Models\Type::withCount('subjects')->find($type->id)->subjects_count }}</td>
                                                <td>
                                                    @can('Subject-show')
                                                        <a class="btn btn-success" href="{{ route('type.subject', $type->id )}}"
                                                           title="{{trans('main_trans.Subject')}}"><i class="fas fa-book"></i> {{' ' . trans('main_trans.Subjects')}}</a>
                                                    @endcan
                                                    @can('Type-edit')
