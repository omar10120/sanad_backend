...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('main_trans.Users') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('main_trans.Add_user') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                        ...
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-4" id="fnWrapper">
                                ...
                                <input class="form-control mg-b-20" id="name_ar"
                                       data-parsley-class-handler="#lnWrapper" name="name_ar" required="" type="text" placeholder="{{ trans('main_trans.First_name') }}">
                            </div>
                        ...
                        <div class="row mg-b-20">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="subjects[]" id="subjects" class="form-control" multiple size="8">
