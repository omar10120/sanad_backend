                            ...
                            <form method="POST" action="updatePassword">
                                ...
                                <div class="form-group row mb-4">
                                    <div class="col-sm-12 col-md-6 mg-t-10 mg-sm-t-0">
                                        <label for="name_ar">{{ trans('main_trans.Name_ar') }}</label>
                                        <input type="hidden" value="{{ Auth::user()->id }}" id="id" name="id" class="form-control">
                                        <input type="text" id="name_ar" value="{{ Auth::user()->name_ar }}" name="name_ar" class="form-control" readonly>
                                    </div>
                                    <div class="col-sm-12 col-md-6 mg-t-10 mg-sm-t-0">
                                        <label for="name_en">{{ trans('main_trans.Name_en') }}</label>
                                        <input type="text" id="name_en" value="{{ Auth::user()->name_en }}" name="name_en" class="form-control" readonly>
                                    </div>
                                </div>
{{--                                <hr class="mg-y-10">--}}
{{--                                <div class="row mb-4">--}}
