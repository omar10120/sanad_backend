$(document).ready(function() {
    ...
    function loadQuestionGroups(lessonId, keepCurrent = false) {
        ...
        $.get(url, function(response) {
            ...
            const newGroupLabel = questionGroupSelect.data('new-group-label') || labels.newGroup || 'مجموعة أسئلة جديدة';
    ...
    function loadLessons(subjectId) {
        ...
        $.get(url, function(response) {
            ...
            const placeholder = labels.selectLesson || 'اختر الدرس';
    ...
    function loadAnswerSection() {
        ...
        if (selectedType === 'TrueOrFalse') {
            ...
            answerHtml = `
            <div class="د-flex align-items-center justify-content-between mb-3">
                ...
                <div>
                    ...
                    ${choices.length > 2 ? '<button type="button" class="btn btn-outline-danger btn-sm" id="removeChoice">حذف خيار</button>' : ''}
                </div>
            </div>
        ...
        `;
            ...
            answerHtml = `
                ...
                <div class="question-editor ltr" id="correctAnswerEditor" style="height: 100px;" data-placeholder="اكتب الإجابة الصحيحة هنا ..."></div>
