...
class UpdateStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'phone' => ['required', 'string', 'min:10', 'max:10', Rule::unique('students', 'phone')->ignore($studentId)],
            'country_code' => ['required', 'string', 'min:1', 'max:10', Rule::unique('students', 'country_code')->ignore($studentId)],
