...
class StoreQuestionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'question_photo' => 'nullable|image|mimes:jpeg,png,jpg|max:2048',
            'hint_photo' => 'nullable|image|mimes:jpeg,png,jpg|max:2048',
            'tags' => 'nullable|array',
            'tags.*' => 'exists:tags,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'question_photo.mimes' => 'صورة السؤال يجب أن تكون من نوع: jpeg, png, jpg',
            'question_photo.max' => 'صورة السؤال يجب أن لا تتجاوز 2 ميجابايت',
            'hint_photo.image' => 'صورة التلميح يجب أن تكون صورة',
            'hint_photo.mimes' => 'صورة التلميح يجب أن تكون من نوع: jpeg, png, jpg',
